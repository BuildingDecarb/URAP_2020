...
class Device:
    def __init__(self, name, fuel, housetype=null, ef, ef_cooler, C, outputTemp=125, s1, s2, Rval0, Rval1, Rval2, vintage, lt, IC, OM, hasRefrigerant=False, refrigerant=Refrigerant()):
        self.name = name
        self.fuel = fuel
